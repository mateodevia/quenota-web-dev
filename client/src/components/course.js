  ...
  addGrade() {
    if (this.state._id) {
      ...
      lista.forEach(function(element) {
        ...
        fetch(
          `http://localhost:3001/students/${localStorage.getItem("email")}`,
          {
            method: "PATCH",
    ...
    return (
      <div className="course" id="course">
        ...
        <div className="form-row">
          ...
          <label for="test1" className="checkbox special">
            <input
              type="checkbox"
              id="test1"
              name="aproximacion"
